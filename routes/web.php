...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::get('/products/new', [\App\Http\Controllers\Product::class, 'new'])->name('product.new');
    Route::post('/products/create', [\App\Http\Controllers\Product::class, 'create'])->name('product.create');
